 ...
 *
 */
public class Users extends DatabaseConnector {
    ...
    // these member fields map directly to the Users DB table columns
    // with the same names, but prefixed with "user_" -- e.g., user_id.
    private int id;
    private String name;
     ...
     *   Users internal data structures.
     * Does NOT set the primary key
     * @param resSet   ResultSet of a Select * from the Users table.
...
//   and then putting it down with the appropriate public Setter.
        ...
        try {
            this.name = resSet.getString("user_name");
            this.password = resSet.getString("user_password");
            success = true;
    ...
    /**
     * Inserts a single record into the Users db table, populating it with the values
...
// return result
    ...
    /**
     * Updates a single record of the Users db table, populating it with the values
     *   stored in the current object instance.
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Deletes a single record from the Users db table, corresponding to the
...
// return result
    ...
    /**
     * Either inserts or updates a single record of the Users db table, depending on
...
// return the result
    ...
    /**
     * Reads a single record of the Users db table
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Deletes the record of the Users db table corresponding to the current object instance
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Setter for user_name table field
     * @param name_new
     * @return void
     */
    ...
    /**
     * Setter for user_password table field
     * @param password_new
     * @return void
     */
    ...
    /**
     * Getter for user_name table field
     * @return String
     */
    ...
    /**
     * Getter for user_password table field
     * @return String
     */
    ...
    /**
     * Constructor creates an empty users object
     * @return  a valid users object that does not map to a record in the DB
     */
    public Users () {
        super();
    ...
    /**
     * Constructor creates a Users object, and attempts to load a record from the DB
     * @return IFF the queryPrimaryKey is valid, a Users object populated with the
     *         corresponding values for that record.
     *         otherwise, returns a valid but empty Users object
     */
    public Users (int queryPrimaryKey) {
        super();
