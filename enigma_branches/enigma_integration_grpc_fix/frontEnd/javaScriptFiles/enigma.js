...
function encrypt(letter) {
  /* WOULD NEED additional manipulation for this--is for whole message, not by letter
 ...
 * Backend message-saving function
 *
 * @todo Make actually use the user-provided config/message
 */
function saveState() {
  // Using the Builder to construct a request
  const EnigmaRequest = new enigma.EnigmaRequestBuilder()
