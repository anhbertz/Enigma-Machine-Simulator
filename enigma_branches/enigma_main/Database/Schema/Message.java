 ...
 *
 */
public class Message extends DatabaseConnector {
    private static final String dbTableName = "Message";
    private static final String primaryKeyColumnName = "message_id";
    private static final int primaryKeyColumnIdx = 1;

    // these member fields map directly to the Message DB table columns
    // with the same names, but prefixed with "message_" -- e.g., message_id.
    private int id;
    private String keyPressed;
    private String lampLetter;
     ...
     *   Message internal data structures.
     * Does NOT set the primary key
     * @param resSet   ResultSet of a Select * from the Message table.
...
//   and then putting it down with the appropriate public Setter.
        ...
        try {
            this.keyPressed = resSet.getString("message_keyPressed");
            this.lampLetter = resSet.getString("message_lampLetter");
            this.encryptedLetter = resSet.getString("message_encryptedLetter");
            success = true;
    ...
    /**
     * Inserts a single record into the Message db table, populating it with the values
    ...
    public boolean create() {
        ...
        String insertSQL = "INSERT INTO " + dbTableName + " ("
                + "message_keyPressed, message_lampLetter, message_encryptedLetter"
                + ") VALUES ('"
                + this.keyPressed + "', '"
                + this.lampLetter + "', '"
...
// return result
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                this.keyPressed = resultSet.getString("message_keyPressed");
                this.lampLetter = resultSet.getString("message_lampLetter");
                this.encryptedLetter = resultSet.getString("message_encryptedLetter");
            } else {
                result = false;
            }
    ...
    /**
     * Updates a single record of the Message db table, populating it with the values
     *   stored in the current object instance.
     * Precondition: the dbConnectionMaker must have been set
...
// return result
        ...
        String updateSQL = "UPDATE " + dbTableName
                + " SET message_keyPressed = " + this.keyPressed + ", "
                + "message_lampLetter = '" + this.lampLetter + ", "
                + "message_encryptedLetter = '" + this.encryptedLetter
    ...
    /**
     * Deletes a single record from the Message db table, corresponding to the
...
// return result
    ...
    /**
     * Either inserts or updates a single record of the Message db table, depending on
...
// return the result
    ...
    /**
     * Reads a single record of the Message db table
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Deletes the record of the Message db table corresponding to the current object instance
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Setter for message_keyPressed table field
     * @param keyPressed_new
     * @return void
     */
    public void setKeyPressed (String keyPressed_new){
        this.keyPressed = keyPressed_new;
    }

    /**
     * Setter for message_lampLetter table field
     * @param lampLetter_new
     * @return void
     */
    public void setLampLetter (String lampLetter_new){
        this.lampLetter = lampLetter_new;
    }

    /**
     * Setter for message_encryptedLetter table field
     * @param encryptedLetter_new
     * @return void
     */
    public void setEncryptedLetter (String encryptedLetter_new){
        this.encryptedLetter = encryptedLetter_new;
    }

    /**
     * Getter for message_keyPressed table field
     * @return String
     */
    ...
    /**
     * Getter for message_password table field
     * @return String
     */
    public String getLampLetter (){
        return this.lampLetter;
    }

    /**
     * Getter for message_encryptedLetter table field
     * @return String
     */
    public String getEncryptedLetter (){
        return this.encryptedLetter;
    }

    /**
     * Constructor creates an empty Message object
     * @return  a valid Message object that does not map to a record in the DB
     */
    public Message () {
        super();
    ...
    /**
     * Constructor creates a Message object, and attempts to load a record from the DB
     * @return IFF the queryPrimaryKey is valid, a Message object populated with the
     *         corresponding values for that record.
     *         otherwise, returns a valid but empty Message object
     */
    public Message (int queryPrimaryKey) {
        super();
