 ...
 *
 */
public class Rotor extends DatabaseConnector {
    private static final String dbTableName = "Rotor";
    private static final String primaryKeyColumnName = "rotor_id";
    private static final int primaryKeyColumnIdx = 1;

    // these member fields map directly to the Rotor DB table columns
    // with the same names, but prefixed with "rotor_" -- e.g., rotor_id.
    private int id;
     ...
     *   Rotor internal data structures.
     * Does NOT set the primary key
     * @param resSet   ResultSet of a Select * from the Rotor table.
...
//   and then putting it down with the appropriate public Setter.
        ...
        try {
            this.wiring = resSet.getString("rotor_wiring");
            this.turnover = resSet.getString("rotor_turnover");
            success = true;
    ...
    /**
     * Inserts a single record into the Rotor db table, populating it with the values
...
// return result
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                this.wiring = resultSet.getString("rotor_wiring");
                this.turnover = resultSet.getString("rotor_turnover");
            } else {
                result = false;
            }
    ...
    /**
     * Updates a single record of the Rotor db table, populating it with the values
     *   stored in the current object instance.
     * Precondition: the dbConnectionMaker must have been set
...
// return result
        ...
        String updateSQL = "UPDATE " + dbTableName
                + " SET rotor_wiring = " + this.wiring + ", "
                + "rotor_turnover = '" + this.turnover
    ...
    /**
     * Deletes a single record from the Rotor db table, corresponding to the
...
// return result
    ...
    /**
     * Either inserts or updates a single record of the Rotor db table, depending on
...
// return the result
    ...
    /**
     * Reads a single record of the Rotor db table
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Deletes the record of the Rotor db table corresponding to the current object instance
     * Precondition: the dbConnectionMaker must have been set
...
// return result
    ...
    /**
     * Setter for rotor_wiring table field
     * @param wiring_new
     * @return void
     */
    ...
    /**
     * Getter for rotor_wiring table field
     * @return String
     */
    ...
    /**
     * Setter for rotor_turnover table field
     * @param turnover_new
     * @return void
     */
    public void setTurnover (String turnover_new){
        this.turnover = turnover_new;
    }


    /**
     * Getter for rotor_name table field
     * @return String
     */
    ...
    /**
     * Constructor creates an empty Rotor object
     * @return  a valid Rotor object that does not map to a record in the DB
     */
    public Rotor () {
        super();
    ...
    /**
     * Constructor creates a Rotor object, and attempts to load a record from the DB
     * @return IFF the queryPrimaryKey is valid, a Rotor object populated with the
     *         corresponding values for that record.
     *         otherwise, returns a valid but empty Rotor object
     */
    public Rotor (int queryPrimaryKey) {
        super();
